export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx03da45becb04bfd2",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "5e08af94926b6fbb7820a501a464e6df",
  ...
  USERS: [
    {
      ...
      id: "onm8j59YdWNFv8SQuhVEvDYeF_h8",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "BD3qfRRFiG7Uf-ck7Mx9p463Hlv1oQ_Jk08M36ZGP5Q",
      // 所在省份
      province: "重庆",
      // 所在城市
      city: "沙坪坝",
